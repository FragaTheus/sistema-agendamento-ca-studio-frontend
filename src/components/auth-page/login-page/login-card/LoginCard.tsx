...
export const LoginCard = () => {
  ...
  return (
    <Card
      ...
      sx={
        isTablet
          ? { width: "80%", height: "60svh", bgcolor: "background.surface" }
          : { width: "40%", height: "60svh", bgcolor: "background.surface" }
      }
    >
      <CardContent
      ...
      >
        ...
        >
          <Box id="card-header" width={"100%"}>
            <Typography level="h2" sx={{ color: "primary.300" }}>
              {loginContent.card.cardTitle}
            </Typography>
          </Box>
          ...
          <Button variant="plain" onClick={() => router.push("/auth/recovery")}>
            {loginContent.card.recoverPassword}
          </Button>
          <Divider />
          <Box
            id="login-register"
          ...
          >
            <Typography>
              {loginContent.card.register.registerDescription}
            </Typography>
            <Button
              variant="plain"
              onClick={() => router.push("/auth/register")}
            >
              {loginContent.card.register.registerButton}
            </Button>
          </Box>
        </Box>
      </CardContent>
